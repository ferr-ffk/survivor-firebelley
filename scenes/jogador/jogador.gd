...
func get_vetor_movimento() -> Vector2:
	...
	var movimento_x = Input.get_action_strength("move_left") - Input.get_action_strength("move_right")
	var movimento_y = Input.get_action_strength("move_up") - Input.get_action_strength("move_down")
